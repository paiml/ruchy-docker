# Multi-stage Dockerfile for Fibonacci benchmark (Ruchy transpiled to Rust)
...
# Metadata labels
LABEL org.opencontainers.image.title="Fibonacci Benchmark (Ruchy Transpiled)"
LABEL org.opencontainers.image.description="BENCH-007: Recursive Fibonacci fib(35) - Ruchy→Rust"

# Multi-stage Dockerfile for Prime Sieve benchmark (Ruchy native compilation)
...
RUN \
    ruchy compile main.ruchy --optimize nasa --output primes
...
# Metadata labels
LABEL org.opencontainers.image.title="Prime Sieve Benchmark (Ruchy Compiled)"
LABEL org.opencontainers.image.description="BENCH-008: Recursive Prime Sieve 100K primes - Ruchy native"
